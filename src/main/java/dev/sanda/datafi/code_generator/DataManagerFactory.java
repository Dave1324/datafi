...
public class DataManagerFactory {
  ...
  private static final ClassName dataManagerType = ClassName.get(
    DataManager.class
  );
  ...
  public void addBasePackageResolver(List<String> modelPackageNames) {
    val builder = MethodSpec
      .methodBuilder("basePackageResolver")
      .addAnnotation(Bean.class)
      .addModifiers(Modifier.PUBLIC)
      .returns(BasePackageResolver.class)
      .addStatement(
        "$T packageNames = new $T()",
        ParameterizedTypeName.get(List.class, String.class),
        ParameterizedTypeName.get(ArrayList.class, String.class)
      );
    modelPackageNames.forEach(
      name -> builder.addStatement("packageNames.add($S)", name)
    );
    dataManagersConfig.addMethod(
      builder
        .addStatement(
          "return new $T($L)",
          BasePackageResolver.class,
          "packageNames"
        )
        .build()
    );
  ...
  private static TypeSpec.Builder initDataManagerConfig() {
    return TypeSpec
      .classBuilder("DataManagersConfig")
      .addAnnotation(Configuration.class)
      .addMethod(
        MethodSpec
          .methodBuilder("nullTypeDataManager")
          .addModifiers(Modifier.PUBLIC)
          .addAnnotation(Bean.class)
